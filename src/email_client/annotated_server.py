...
class EmailMCPServer(BaseMCPServer):
    ...
    @mcp_tool(name="get-email-content")
    ...
    @mcp_tool(name="count-daily-emails")
    ...
    @mcp_tool(name="update-collection")
    async def update_collection(self, collection_id: str, operation: str) -> Dict[str, Any]:
    ...
    @mcp_tool(name="fetch-collection")
    ...
    @mcp_tool(name="list-collections")
    ...
    @mcp_tool(name="preview-collection")
    async def preview_collection(self, collection_id: str, rows: int = 5) -> Dict[str, Any]:
    ...
    @mcp_tool(name="combine-collections")
    async def combine_collections(
        self,
